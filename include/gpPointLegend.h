#ifndef MPPOINTLEGEND_H
#define MPPOINTLEGEND_H
...
/** @class mpNoteLegend
    ...
    -Support multiline */
class WXDLLIMPEXP_MATHPLOT mpPointLegend : public mpInfoLayer
{
public:
    /** Default constructor */
    mpPointLegend();
    ...
    mpPointLegend(wxRect rect, const wxBrush* brush = wxTRANSPARENT_BRUSH);
